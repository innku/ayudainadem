...
RSpec.describe ArticulosController, :type => :controller do
  ...
  describe "GET new" do
    it "assigns a new articulo as @articulo" do
      ...
      expect(assigns(:articulo)).to be_a_new(Articulo)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created articulo as @articulo" do
        post :create, {:articulo => valid_attributes}, valid_session
        expect(assigns(:articulo)).to be_a(Articulo)
        expect(assigns(:articulo)).to be_persisted
      end

      it "redirects to the created articulo" do
        post :create, {:articulo => valid_attributes}, valid_session
        expect(response).to redirect_to(Articulo.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved articulo as @articulo" do
        post :create, {:articulo => invalid_attributes}, valid_session
        expect(assigns(:articulo)).to be_a_new(Articulo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested articulo" do
        articulo = Articulo.create! valid_attributes
        put :update, {:id => articulo.to_param, :articulo => new_attributes}, valid_session
        articulo.reload
      ...
      it "redirects to the articulo" do
        articulo = Articulo.create! valid_attributes
        put :update, {:id => articulo.to_param, :articulo => valid_attributes}, valid_session
        expect(response).to redirect_to(articulo)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the articulo as @articulo" do
        articulo = Articulo.create! valid_attributes
        put :update, {:id => articulo.to_param, :articulo => invalid_attributes}, valid_session
        expect(assigns(:articulo)).to eq(articulo)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the articulos list" do
      articulo = Articulo.create! valid_attributes
      delete :destroy, {:id => articulo.to_param}, valid_session
      expect(response).to redirect_to(articulos_url)
    end
  end
